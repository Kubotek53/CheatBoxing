...
/// <summary>
/// Tworzy CAŁY UI sceny głównego menu przez kod — zero ręcznego składania w Inspectorze.
/// Dodaj ten skrypt do pustego GameObject "MainMenuBootstrap" w scenie.
...
public class MainMenuBootstrap : MonoBehaviour
{
        ...
        Color barColor, string labelText)
    {
        ...
        // Panel tła
        var panel = UIHelpers.CreateUIObject(name + "Panel", canvas.transform);
        var panelRT = panel.GetComponent<RectTransform>();
        panelRT.sizeDelta = new Vector2(size.x, size.y + 28);
        UIHelpers.SetAnchorCorner(panelRT, isLeft ? UIHelpers.Corner.TopLeft : UIHelpers.Corner.TopRight, anchoredPos);
        var panelImg = panel.AddComponent<Image>();
        panelImg.color = COL_PANEL;

        // Label (GRACZ / WRÓG)
        var labelGO = UIHelpers.CreateUIObject(name + "Label", panel.transform);
        ...
        // Slider
        var sliderGO = UIHelpers.CreateUIObject(name + "Slider", panel.transform);
        ...
        // Background paska
        var bg = UIHelpers.CreateUIObject("Background", sliderGO.transform);
        ...
        // Fill Area
        var fillArea = UIHelpers.CreateUIObject("Fill Area", sliderGO.transform);
        ...
        // Fill
        var fill = UIHelpers.CreateUIObject("Fill", fillArea.transform);
